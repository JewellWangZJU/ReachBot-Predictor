...
# Name of the run
# string
WANDB_RUN_NAME = "3-DICE-1-Skil-DICE"

# Define the model here (2 modifications!) (from custom_configs/models)
# string
MODEL = "vit_vit-b16_mln_upernet_cracks"
_base_ = [
    "../../../custom_configs/models/vit-b16_mln_upernet_cracks.py",
]

# Define the dataset (from custom_configs/datasets)
# string
DATASET = "cracks_combined"
...
LOSSES = {
    ...
    "skil_dice": (
        1.0,
        dict(epsilon=0.01, border_factor=0.82, border_size=20, iterations=50),
    ),
}
